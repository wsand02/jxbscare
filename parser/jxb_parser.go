...
func jxbParserInit() {
	...
	staticData.serializedATN = []int32{
		4, 1, 13, 71, 2, 0, 7, 0, 2, 1, 7, 1, 2, 2, 7, 2, 2, 3, 7, 3, 2, 4, 7,
		...
		8, 10, 12, 0, 1, 2, 0, 5, 5, 9, 11, 71, 0, 17, 1, 0, 0, 0, 2, 26, 1, 0,
		...
		1, 0, 0, 0, 27, 3, 1, 0, 0, 0, 28, 32, 5, 5, 0, 0, 29, 31, 5, 11, 0, 0,
		30, 29, 1, 0, 0, 0, 31, 34, 1, 0, 0, 0, 32, 30, 1, 0, 0, 0, 32, 33, 1,
		0, 0, 0, 33, 35, 1, 0, 0, 0, 34, 32, 1, 0, 0, 0, 35, 36, 5, 13, 0, 0, 36,
		5, 1, 0, 0, 0, 37, 38, 5, 2, 0, 0, 38, 39, 5, 11, 0, 0, 39, 43, 5, 13,
		0, 0, 40, 42, 3, 4, 2, 0, 41, 40, 1, 0, 0, 0, 42, 45, 1, 0, 0, 0, 43, 41,
		1, 0, 0, 0, 43, 44, 1, 0, 0, 0, 44, 46, 1, 0, 0, 0, 45, 43, 1, 0, 0, 0,
		46, 47, 5, 3, 0, 0, 47, 48, 5, 11, 0, 0, 48, 49, 5, 13, 0, 0, 49, 7, 1,
		0, 0, 0, 50, 51, 5, 4, 0, 0, 51, 53, 7, 0, 0, 0, 52, 54, 5, 6, 0, 0, 53,
		52, 1, 0, 0, 0, 53, 54, 1, 0, 0, 0, 54, 55, 1, 0, 0, 0, 55, 56, 5, 13,
		...
		13, 0, 0, 66, 11, 1, 0, 0, 0, 67, 68, 5, 8, 0, 0, 68, 69, 3, 8, 4, 0, 69,
...
func (s *InsertContext) BR() antlr.TerminalNode {
	return s.GetToken(JXBParserBR, 0)
}
...
func (p *JXBParser) Insert() (localctx IInsertContext) {
	...
	}
	{
		...
		if !((int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&3616) != 0) {
